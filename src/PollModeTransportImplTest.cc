...
class PollModeTransportImplTest : public ::testing::Test {
  public:
    PollModeTransportImplTest()
        ...
        , transport(new PollModeTransportImpl(mockDriver, mockSender,
                                              mockReceiver, 22))
    {
    ...
    PollModeTransportImpl* transport;
};

TEST_F(PollModeTransportImplTest, poll)
{
...
TEST_F(PollModeTransportImplTest, processPackets)
{
    char payload[8][1024];
