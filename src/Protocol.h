 ...
 */
struct HeaderPrefix {
    uint16_t sport;   ///< Transport layer (L4) source and destination ports
    uint16_t dport;   ///< in network byte order; only used by DataHeader.
    uint8_t version;  ///< The version of the protocol being used by this packet
